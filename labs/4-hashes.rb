...
# this is a short version: puts bitcoin_data ["bpi"] ["USD"] ["rate_float"]

# dig through bitcoin_data to find the conversion rate (rate_float)
conversion_rate = bitcoin_data["bpi"] ["USD"] ["rate_float"]

# put the conversion rate on screeen
puts "One BTC is worth #{conversion_rate} USD"

# multiply the conversion rate by the # of bitcoin
value_of_bitcoin = bitcoin * conversion_rate

#write the value of the user's bitcoin on screen
puts "You have BTC worth #{value_of_bitcoin} USD"